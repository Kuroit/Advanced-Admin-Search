...
function aaskp_search_page_callback() { 
    ...
    <div class="advanced-admin-wrapper">
        ...
        <form action="" method="GET">
            ...
            <input name="keyword" class="input_search" type="text" value="<?php if(isset($selectedKeyword) && $selectedKeyword!='') echo $selectedKeyword; ?>" placeholder="Search in database" id="post_search_box1" autocomplete="off" required />
            ...
            <input type="text" input class="input_page input_search" name="user" placeholder="Filter by author ID or username" value="<?php if(isset($selectedUser) && $selectedUser!='') echo $selectedUser?>"/></br>
            ...
            <div class="advanced_search">
                ...
                <input type="text" input class="input_key input_search" name="metaKey" placeholder="Filter by meta key" value="<?php if(isset($selectedMetaKey) && $selectedMetaKey!='') echo $selectedMetaKey?>" disabled="" title="Check the box above to enable meta search fields" />

                <input type="text" input class="input_value input_search" name="metaValue" placeholder="Filter by meta value" value="<?php if(isset($selectedMetaVal) && $selectedMetaVal!='') echo $selectedMetaVal?>" disabled="" title="Check the box above to enable meta search fields" />
